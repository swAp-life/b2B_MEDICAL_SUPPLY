			...
			<div id="content">
              ...
              -->
				...
				<div class="container-fluid">
					...
					<form action="manufacturerAddProduct" method="post">
						<div class="form-group col-sm-6">
							<span class="font-weight-bold">Product Name</span> <input
								type="text" class="form-control form-control-user"
								name="prodName" id="prodName" placeholder="Product Name">
						</div>
						<div class="form-group col-sm-6">
							<span class="font-weight-bold">Product Cost</span> <input
								type="text" class="form-control form-control-user"
								name="prodCost" id="prodCost" placeholder="Product Cost">
						</div>
						<div class="form-group col-sm-6">
							<span class="font-weight-bold">Product Quantity</span> <input
								type="text" class="form-control form-control-user"
								name="prodQuantity" id="prodQuantity"
