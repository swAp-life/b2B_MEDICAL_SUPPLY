						...
						<div class="container-fluid bg-gradient-primary " class="rounded"
							...
							<div class="row" align="center">
								...
								<div class="col-lg-6" align="left"
									...
									<div>
										<!--  <div><b>Order Id</b><pre></pre><p style="width: 300px" name="orderId">Order</p></div><br> -->
										<div>
											<b>Product Name</b>
											<pre></pre>
										...
										<div>
											...
											<pre></pre>
											<p style="width: 300px" name="manufacturerName">${orders.manuName}</p>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6 " align="left"
									...
									<div>
										...
										<br>
										<!--  <div><b>Delivery Date</b><pre></pre><p style="width: 300px" name="deliveryStatus">Delivery Date</p></div> -->
									</div>
								</div>
							</div>
						</div>
